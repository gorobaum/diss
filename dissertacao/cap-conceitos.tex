...
podem realizar mais de um passo por vez. Os passos gerais são representados na imagem \ref{fig:regExplicacao}, retirado 
de \cite{zitova2003image}. Vamos tratar brevemente dos passos nas seções abaixo.
\begin{figure}[H]
    \centering
...
função e a sua reamostragem da imagem Alvo. }
...
\subsection{Correspondência de caracteristicas}\index{Correspondência de caracteristicas}
    ...
    O primeiro método, Correspondência por Área, mescla o passo de Detecção com o de Correspondência. Ele utiliza duas
janelas, uma para cada imagem, de formato retangular ou circular, e utiliza metricas para enumerar a relação entre 
elas. O algoritmo então move as janelas afim de encontrar a máxima relação. Os algoritmos 

...
do TPS. A primeira, \codepagode{resolverEquLinear}, cria e resolve uma equação
linear. Essa função é chamada uma vez para cada dimensão da imagem. Logo após,
temos a \codepagode{funcaoDeformacao}, que dado uma coordenada na imagem
resultado, retorna a coordenada da imagem alvo na qual está a sua intensidade.
Por fim, a \codepagode{interpolacao} retorna a intensidade com base na
coordenada encontrada no passo anterior. A execução de uma instância de registro
está na função \codepagode{tps}, abaixo:
